...
- Copied selections now strip message frame borders and box-drawing decorations so only the actual text lands on the clipboard; successful copies show a solid green “✓ Copied” badge below the editor.
