...
- Reasserted application mouse tracking after session rebinding so wheel scrolling cancels active Workbench selection instead of extending the selected chat range.
